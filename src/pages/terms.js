    ...
    return (
      <Layout location={location}>
        <div className="container">
          ...
          <p>
            These Website/App Standard Terms and Conditions written on this
            webpage shall manage your use of our Website/App, Playpost
          ...
          <p>
            ...
            Website/App if you disagree with any of these Website/App Standard
          ...
          <p>
            Other than the content you own, under these Terms, Playpost and/or
          ...
          <ul>
            ...
            <li>
              using this Website/App in any way that is or may be damaging to
              this Website/App;
            </li>
            <li>
              using this Website/App in any way that impacts user access to this
              Website/App;
            </li>
            <li>
              using this Website/App contrary to applicable laws and
              regulations, or in any way may cause harm to the Website/App, or
              to any person or business entity;
            </li>
            <li>
              engaging in any data mining, data harvesting, data extracting or
              any other similar activity in relation to this Website/App;
            </li>
            <li>
          ...
          <p>
            Certain areas of this Website/App are restricted from being access
            by you and Playpost may further restrict access by you to any areas
            of this Website/App, at any time, in absolute discretion. Any user
            ID and password you may have for this Website/App are confidential
          ...
          <p>
            In these Website/App Standard Terms and Conditions, "Your Content"
            shall mean any audio, video text, images or other material you
            choose to display on this Website/App. By displaying Your Content,
            you grant Playpost a non-exclusive, worldwide irrevocable, sub
          ...
          <p>
            ...
            third-party’s rights. Playpost reserves the right to remove any of
            Your Content from this Website/App at any time without notice.
          </p>

          <h2>No warranties</h2>

          <p>
            This Website/App is provided "as is," with all faults, and Playpost
            express no representations or warranties, of any kind related to
            this Website/App or the materials contained on this Website/App.
            Also, nothing contained on this Website/App shall be interpreted as
            advising you.
          </p>

          <p>
            Playpost cannot be held responsible for articles not being processed
            correctly when those articles are behind a pay-wall or require a
            login. As the Service only has access to the publicly available
            articles.
          </p>

          <p>
            The app enforces a fair use policy, meaning there is a restriction
            applied to heavy users. Therefore usage is restricted with a max of
            30 minutes per article. And monthly limited to 300 minutes per user.
            The user will be notified when that limit is reached.
          </p>

          <h2>Limitation of liability</h2>

          <p>
            In no event shall Playpost, nor any of its officers, directors and
            employees, shall be held liable for anything arising out of or in
            any way connected with your use of this Website/App whether such
            liability is under contract. Playpost, including its officers,
            ...
            related to your use of this Website/App.
          </p>

          <h2>Indemnification</h2>

          <p>
            You hereby indemnify to the fullest extent Playpost from and against
          ...
          <p>
            Playpost is permitted to revise these Terms at any time as it sees
            fit, and by using this Website/App you are expected to review these
          ...
          <p>
            These Terms constitute the entire agreement between Playpost and you
            in relation to your use of this Website/App, and supersede all prior
          ...
          <p>
            ...
            the laws of the State of ro, and you submit to the non-exclusive
            jurisdiction of the state and federal courts located in ro for the
