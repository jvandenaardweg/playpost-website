...
import { GOOGLE_CHROME_EXTENSION_URL } from '../constants/urls'

class Chrome extends React.Component {
  render() {
    const { location } = this.props

    const pageTitle = 'Chrome browser extension'
    const pageDescription = `Save articles directly to your playlist from your Google Chrome browser using the "Save to Playpost" desktop browser extension.`
            ...
            <div className="px-1">
              ...
              <div className="row pb-md-4">
                <div className="col-12 col-md-4 mb-3">
                  ...
                  <p>
                    Articles saved from the Google Chrome extension are saved to
                    your playlist in the iOS or Android app. Just open the app
                    and press play.
                  </p>
                </div>
                <div className="col-12 col-md-4 mb-3">
