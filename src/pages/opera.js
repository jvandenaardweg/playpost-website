...
import { OPERA_EXTENSION_URL } from '../constants/urls'

class Opera extends React.Component {
  render() {
    const { location } = this.props

    const pageTitle = 'Opera browser extension'
    const pageDescription = `Save articles directly to your playlist from your Opera browser using the "Save to Playpost" desktop browser extension.`
    ...
    return (
      <Layout location={location}>
        <Helmet>
          ...
          <meta property="og:url" content="https://playpost.app/opera" />
        </Helmet>
        <CenterHeader
          title={pageTitle}
            ...
            <div className="px-1">
              <div className="row justify-content-between align-items-center mb-5">
                <div className="col-12 col-md-6 order-2 order-md-1">
                  ...
                  <a className="action-link" href={OPERA_EXTENSION_URL}>
              ...
              <div className="row pb-md-4">
                <div className="col-12 col-md-4 mb-3">
                  ...
                  <p>
                    Articles saved from the Opera extension are saved to your
